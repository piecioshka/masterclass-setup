# WarsawJS MasterClass #6 — Wymagane oprogramowanie
...
```bash
mkdir -p /tmp/
curl -sSL https://raw.githubusercontent.com/warsawjs/masterclass-setup/master/6/.solidarity.json > /tmp/.solidarity.json
